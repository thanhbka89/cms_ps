...
function (_Vue) {
  ...
  vue_slider_createClass(VueSlider, [{
    ...
    value: function keydownHandle(e) {
      ...
      if (handleFunc) {
        e.preventDefault();
        var index = this.control.getIndexByValue(this.control.dotsValue[this.focusDotIndex]);
        var newIndex = handleFunc(index);
        var pos = this.control.parseValue(this.control.getValueByIndex(newIndex));
        this.isCrossDot(pos);
        this.control.setDotPos(pos, this.focusDotIndex);
        this.syncValueByPos();
      }
    ...
    value: function render() {
      ...
      return h("div", helper_default()([{
        ...
        return _this6.renderSlot('process', item, h("div", {
        ...
        return _this6.renderSlot('mark', mark, h("vue-slider-mark", {
          ...
          "style": (_style = {}, vue_slider_defineProperty(_style, _this6.isHorizontal ? 'height' : 'width', '100%'), vue_slider_defineProperty(_style, _this6.isHorizontal ? 'width' : 'height', _this6.tailSize), vue_slider_defineProperty(_style, _this6.mainDirection, "".concat(mark.pos, "%")), _style),
          "on": {
            "pressLabel": function pressLabel(pos) {
              return _this6.setValueByPos(pos);
            }
          }
        }, [_this6.renderSlot('step', mark, null), _this6.renderSlot('label', mark, null)]), true);
        ...
        return h("vue-slider-dot", {
          ...
          "attrs": {
            ...
            "tooltip-style": [_this6.tooltipStyle, dot.tooltipStyle, dot.disabled ? dot.tooltipDisabledStyle : null, dot.focus ? dot.tooltipFocusStyle : null],
            "tooltip-formatter": Array.isArray(_this6.tooltipFormatter) ? _this6.tooltipFormatter[index] : _this6.tooltipFormatter,
            "tooltip-placement": _this6.tooltipDirections[index]
          },
          "style": [_this6.dotBaseStyle, (_ref = {}, vue_slider_defineProperty(_ref, _this6.mainDirection, "".concat(dot.pos, "%")), vue_slider_defineProperty(_ref, "transition", "".concat(_this6.mainDirection, " ").concat(_this6.animateTime, "s")), _ref)],
          "on": {
            "drag-start": function dragStart() {
              return _this6.dragStart(index);
            }
          }
        }, [_this6.renderSlot('dot', dot, null), _this6.renderSlot('tooltip', dot, null)]);
    ...
    get: function get() {
      ...
      return this.control.processArray.map(function (_ref4) {
        ...
        return {
          ...
          style: vue_slider_objectSpread((_objectSpread2 = {}, vue_slider_defineProperty(_objectSpread2, _this7.isHorizontal ? 'height' : 'width', '100%'), vue_slider_defineProperty(_objectSpread2, _this7.isHorizontal ? 'top' : 'left', 0), vue_slider_defineProperty(_objectSpread2, _this7.mainDirection, "".concat(start, "%")), vue_slider_defineProperty(_objectSpread2, sizeStyleKey, "".concat(end - start, "%")), vue_slider_defineProperty(_objectSpread2, "transitionProperty", "".concat(sizeStyleKey, ",").concat(_this7.mainDirection)), vue_slider_defineProperty(_objectSpread2, "transitionDuration", "".concat(_this7.animateTime, "s")), _objectSpread2), _this7.processStyle, style)
        };
      });
    }
  }, {
    ...
    get: function get() {
      ...
      return this.control.dotsPos.map(function (pos, index) {
        return vue_slider_objectSpread({
          ...
          style: _this8.dotStyle
        }, (Array.isArray(_this8.dotOptions) ? _this8.dotOptions[index] : _this8.dotOptions) || {});
      });
    }
  }, {
    key: "animateTime",
